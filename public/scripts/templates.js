        ...
        ;(function(){
            ...
            if ('number' == typeof $$obj.length) {
                ...
                for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
                    ...
                    buf.push("<li" + (jade.attr("id", val.row, true, false)) + (jade.attr("data-track_id", val.id, true, false)) + (jade.attr("data-event_id", val.event.event_id, true, false)) + " class=\"tracklist track-playable\">" + (jade.escape(null == (jade_interp = val.track.title) ? "" : jade_interp)) + "</li>");
                }
